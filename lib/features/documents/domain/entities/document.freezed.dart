...
mixin _$Document {
 ...
 String get id; String get title; String? get description; String? get thumbnail; MainDocumentType get mainType; DocumentSubType? get subType; List<String> get tags; DateTime? get expiryDate; bool get isFavorite; int get bundleCount; DateTime get createdAt; DateTime get updatedAt; List<String> get filePaths; String? get ocrText; DocumentMetadata get metadata; Map<String, dynamic> get extractedData;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Document&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description)&&(identical(other.thumbnail, thumbnail) || other.thumbnail == thumbnail)&&(identical(other.mainType, mainType) || other.mainType == mainType)&&(identical(other.subType, subType) || other.subType == subType)&&const DeepCollectionEquality().equals(other.tags, tags)&&(identical(other.expiryDate, expiryDate) || other.expiryDate == expiryDate)&&(identical(other.isFavorite, isFavorite) || other.isFavorite == isFavorite)&&(identical(other.bundleCount, bundleCount) || other.bundleCount == bundleCount)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&const DeepCollectionEquality().equals(other.filePaths, filePaths)&&(identical(other.ocrText, ocrText) || other.ocrText == ocrText)&&(identical(other.metadata, metadata) || other.metadata == metadata)&&const DeepCollectionEquality().equals(other.extractedData, extractedData));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,thumbnail,mainType,subType,const DeepCollectionEquality().hash(tags),expiryDate,isFavorite,bundleCount,createdAt,updatedAt,const DeepCollectionEquality().hash(filePaths),ocrText,metadata,const DeepCollectionEquality().hash(extractedData));

@override
String toString() {
  return 'Document(id: $id, title: $title, description: $description, thumbnail: $thumbnail, mainType: $mainType, subType: $subType, tags: $tags, expiryDate: $expiryDate, isFavorite: $isFavorite, bundleCount: $bundleCount, createdAt: $createdAt, updatedAt: $updatedAt, filePaths: $filePaths, ocrText: $ocrText, metadata: $metadata, extractedData: $extractedData)';
}
...
@useResult
$Res call({
 String id, String title, String? description, String? thumbnail, MainDocumentType mainType, DocumentSubType? subType, List<String> tags, DateTime? expiryDate, bool isFavorite, int bundleCount, DateTime createdAt, DateTime updatedAt, List<String> filePaths, String? ocrText, DocumentMetadata metadata, Map<String, dynamic> extractedData
});
...
/// Create a copy of Document
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? description = freezed,Object? thumbnail = freezed,Object? mainType = null,Object? subType = freezed,Object? tags = null,Object? expiryDate = freezed,Object? isFavorite = null,Object? bundleCount = null,Object? createdAt = null,Object? updatedAt = null,Object? filePaths = null,Object? ocrText = freezed,Object? metadata = null,Object? extractedData = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
as String,description: freezed == description ? _self.description : description // ignore: cast_nullable_to_non_nullable
as String?,thumbnail: freezed == thumbnail ? _self.thumbnail : thumbnail // ignore: cast_nullable_to_non_nullable
as String?,mainType: null == mainType ? _self.mainType : mainType // ignore: cast_nullable_to_non_nullable
as MainDocumentType,subType: freezed == subType ? _self.subType : subType // ignore: cast_nullable_to_non_nullable
as DocumentSubType?,tags: null == tags ? _self.tags : tags // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String? description,  String? thumbnail,  MainDocumentType mainType,  DocumentSubType? subType,  List<String> tags,  DateTime? expiryDate,  bool isFavorite,  int bundleCount,  DateTime createdAt,  DateTime updatedAt,  List<String> filePaths,  String? ocrText,  DocumentMetadata metadata,  Map<String, dynamic> extractedData)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Document() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.thumbnail,_that.mainType,_that.subType,_that.tags,_that.expiryDate,_that.isFavorite,_that.bundleCount,_that.createdAt,_that.updatedAt,_that.filePaths,_that.ocrText,_that.metadata,_that.extractedData);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String? description,  String? thumbnail,  MainDocumentType mainType,  DocumentSubType? subType,  List<String> tags,  DateTime? expiryDate,  bool isFavorite,  int bundleCount,  DateTime createdAt,  DateTime updatedAt,  List<String> filePaths,  String? ocrText,  DocumentMetadata metadata,  Map<String, dynamic> extractedData)  $default,) {final _that = this;
switch (_that) {
case _Document():
return $default(_that.id,_that.title,_that.description,_that.thumbnail,_that.mainType,_that.subType,_that.tags,_that.expiryDate,_that.isFavorite,_that.bundleCount,_that.createdAt,_that.updatedAt,_that.filePaths,_that.ocrText,_that.metadata,_that.extractedData);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String? description,  String? thumbnail,  MainDocumentType mainType,  DocumentSubType? subType,  List<String> tags,  DateTime? expiryDate,  bool isFavorite,  int bundleCount,  DateTime createdAt,  DateTime updatedAt,  List<String> filePaths,  String? ocrText,  DocumentMetadata metadata,  Map<String, dynamic> extractedData)?  $default,) {final _that = this;
switch (_that) {
case _Document() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.thumbnail,_that.mainType,_that.subType,_that.tags,_that.expiryDate,_that.isFavorite,_that.bundleCount,_that.createdAt,_that.updatedAt,_that.filePaths,_that.ocrText,_that.metadata,_that.extractedData);case _:
  return null;
...
@override final  MainDocumentType mainType;
@override final  DocumentSubType? subType;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Document&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description)&&(identical(other.thumbnail, thumbnail) || other.thumbnail == thumbnail)&&(identical(other.mainType, mainType) || other.mainType == mainType)&&(identical(other.subType, subType) || other.subType == subType)&&const DeepCollectionEquality().equals(other._tags, _tags)&&(identical(other.expiryDate, expiryDate) || other.expiryDate == expiryDate)&&(identical(other.isFavorite, isFavorite) || other.isFavorite == isFavorite)&&(identical(other.bundleCount, bundleCount) || other.bundleCount == bundleCount)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&const DeepCollectionEquality().equals(other._filePaths, _filePaths)&&(identical(other.ocrText, ocrText) || other.ocrText == ocrText)&&(identical(other.metadata, metadata) || other.metadata == metadata)&&const DeepCollectionEquality().equals(other._extractedData, _extractedData));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,thumbnail,mainType,subType,const DeepCollectionEquality().hash(_tags),expiryDate,isFavorite,bundleCount,createdAt,updatedAt,const DeepCollectionEquality().hash(_filePaths),ocrText,metadata,const DeepCollectionEquality().hash(_extractedData));
...
as String?,mainType: null == mainType ? _self.mainType : mainType // ignore: cast_nullable_to_non_nullable
as MainDocumentType,subType: freezed == subType ? _self.subType : subType // ignore: cast_nullable_to_non_nullable
as DocumentSubType?,tags: null == tags ? _self._tags : tags // ignore: cast_nullable_to_non_nullable
as List<String>,expiryDate: freezed == expiryDate ? _self.expiryDate : expiryDate // ignore: cast_nullable_to_non_nullable
as DateTime?,isFavorite: null == isFavorite ? _self.isFavorite : isFavorite // ignore: cast_nullable_to_non_nullable
as bool,bundleCount: null == bundleCount ? _self.bundleCount : bundleCount // ignore: cast_nullable_to_non_nullable
as int,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
